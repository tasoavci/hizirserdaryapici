...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        header("refresh:0;url=index.php");
            ...
            {
                mysqli_query($db,"update home set Home_Title='".p("home_title")."', Home_Text='".p("home_text")."'");
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple1">
                                            ...
                                            <tbody>
                                            <?php while ($homeslider=mysqli_fetch_array($slider)){ ?>
                                                <tr>
                                                    <td><?php echo $homeslider['Homeslider_Title'];?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=a&duzen=".$homeslider["Homeslider_Id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=a&sil='.$homeslider["Homeslider_Id"] ?>">
