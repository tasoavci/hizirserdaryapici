                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                        ...
                                        <table id="datatablesSimple1">
                                            ...
                                            <?php while ($cvdetail=mysqli_fetch_array($cvpage)){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=c&duzen=".$cvdetail["Cv_Id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=c&sil='.$cvdetail["Cv_Id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=c">Yeni Ekle</a>
