                                                ...
                                                <tr>
                                                    <td>
                                                        <?php if($portfolio['Portfolio_Type']=="images"){ ?>
                                                            <img style="width: 70%; margin-bottom: 2%;" src="<?php echo 'https://hizirserdaryapici.com/assets/img/portfolio/'.$portfolio['Portfolio_Frontimg'];?>"/>
                                                        <?php }else{ ?>
                                                            <video style="width: 70%; margin-bottom: 2%;" controls>
                                                                <source src="<?php echo 'https://hizirserdaryapici.com/assets/img/portfolio/'.$portfolio['Portfolio_Frontimg'];?>">
                                                            </video>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
                                                        <?php if($portfolio['Portfolio_Type']=="images"){ ?>
                                                            <img style="width: 35%; margin-bottom: 2%;" src="<?php echo 'https://hizirserdaryapici.com/assets/img/SERDAR_PORTFOLIO/'.$portfolio['Portfolio_Magnificationimg'];?>"/>
                                                        <?php }else{ ?>
                                                            <video style="width: 70%; margin-bottom: 2%;" controls>
                                                                <source src="<?php echo 'https://hizirserdaryapici.com/assets/img/SERDAR_PORTFOLIO/'.$portfolio['Portfolio_Magnificationimg'];?>">
                                                            </video>
                                                        <?php } ?>
