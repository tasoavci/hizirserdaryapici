                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple1">
                                            <thead>
                                                <tr>
                                                    <th>Referans İsmi:</th>
                                                    <th>Referans Firması:</th>
                                                    <th>Referans Pozisyonu:</th>
                                                    <th>Referans Email:</th>
                                                    <th>Referans Telefonu:</th>
                                            ...
                                            <?php while ($testimonial=mysqli_fetch_array($testimonials)){ ?>
                                                <tr>
                                                    <td><?php echo $testimonial['Testimonials_User'];?></td>
                                                    <td><?php echo $testimonial['Testimonials_Company'];?></td>
                                                    <td><?php echo $testimonial['Testimonials_Position'];?></td>
                                                    <td><?php echo $testimonial['Testimonials_Email'];?></td>
                                                    <td><?php echo $testimonial['Testimonials_Phone'];?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=r&duzen=".$testimonial["Testimonials_Id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=r&sil='.$testimonial["Testimonials_Id"] ?>">
