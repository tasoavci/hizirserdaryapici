...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        header("refresh:0;url=index.php");
            ...
            $paragraph=mysqli_query($db,"select * from skills");
            $info=mysqli_query($db,"select * from skillslist");
?>
<html>
    <head>
        <meta charset="utf-8" />
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple1">
                                            ...
                                            <tbody>
                                            <?php while ($skillsparagraph=mysqli_fetch_array($paragraph)){ ?>
                                                <tr>
                                                    <td><?php echo $skillsparagraph['Skills_Paragraph'];?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=yp&duzen=".$skillsparagraph["Skills_Id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=yp&sil='.$skillsparagraph["Skills_Id"] ?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=yp">Yeni Ekle</a>
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple2">
                                            ...
                                            <tbody>
                                            <?php while ($skillsinfo=mysqli_fetch_array($info)){ ?>
                                                <tr>
                                                    <td><?php echo $skillsinfo['Skillslist_Title'];?></td>
                                                    <td><?php echo $skillsinfo['Skillslist_Percentile'];?></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=ys&duzen=".$skillsinfo["Skillslist_Id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=ys&sil='.$skillsinfo["Skillslist_Id"] ?>">
                                                            <input class="btn btn-danger" type="submit" value="Sil">
                                                        </a>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=ys">Yeni Ekle</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
